...
- 2026/09/21 — **v0.14.24**
    - 案内ページ [potalk.app/start/](https://potalk.app/start/) を作りました。はじめての方向けの入口で、いつも用意してある 2 つの席（はじめましての席／声を試す席）に人がいるかどうかが見えます
    - いつも用意してある席への直リンクは、入口の確認を挟まずにそのまま入れるようにしました
---
